...
def info_user () :
	...
	if user == "" :
		...
		#put_html ('<p> <img src="https://i.pinimg.com/originals/b9/45/b1/b945b18e0b0a1ce15ef5991b1c1cb56c.jpg" width=150> </p>')
		#put_text ("Username :"+str(user))
...
if __name__=="__main__":
	start_server (info_user,port=8083, debug=True)
